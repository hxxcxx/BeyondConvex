...
#include "../../../src/spatial_index/bvhtree/bvhtree.h"
#include <vector>
#include <memory>
#include <imgui.h>
...
class BVHScene : public GeometryScene {
 public:
  BVHScene();
  
  std::string Name() const override {
    return "BVH Tree Demo";
  }
  
  std::string Description() const override {
    return "Bounding Volume Hierarchy visualization - optimized for complex spatial queries using SAH. Click to add points and test queries.";
  }
 ...
 private:
  ...
  // Rendering helpers
  void RenderBVHTree(const BVHNode* node, 
